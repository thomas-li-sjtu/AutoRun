...
void get_description(QString *description, QString path)
{
    ...
    BOOL result = get_file_version_string(tmp, _T("FileDescription"), ptszStr, 1024);
    *description = result ? QString::fromWCharArray(ptszStr) : "";

    delete[] ptszStr;
}

BOOL get_file_version_string(LPCTSTR pFileName, LPCTSTR pName /* = NULL */, LPTSTR ptBuf, UINT lenBuf)
{
